import svgPaths from "./svg-ler3i4is66";
...
function AddCta() {
  return (
    <div className="bg-[rgba(100,182,172,0.1)] box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[35px] py-[9px] relative rounded-[50px] shrink-0" data-name="Add_Cta">
...
function Frame28() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1472} />
      </div>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1473} />
      </div>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1474} />
      </div>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1475} />
      </div>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1476} />
      </div>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1477} />
      </div>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1478} />
      </div>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1479} />
      </div>
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[80px]">
      <div className="absolute h-[70px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[72px]" data-name="image 1466">
        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1480} />
      </div>
    </div>
  );
}
...
function Frame115({ onCartClick }: { onCartClick?: () => void }) {
  return (
...
function Frame65() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[80px] top-[548px]">
      ...
      <div className="flex h-[21px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "21", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
...
export default function Desktop({ onCartClick }: { onCartClick?: () => void }) {
  return (
    <div className="bg-white relative size-full" data-name="Desktop - 10">
      <Frame96 />
      <Frame115 onCartClick={onCartClick} />
      <Frame51 />
    </div>
  );
}