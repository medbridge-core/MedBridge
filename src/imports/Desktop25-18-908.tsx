...
import svgPaths from "./svg-8kwbvssavk";
    ...
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="Medical Visa icon" className="absolute h-[102.13%] left-[-5.21%] max-w-none top-0 w-full" src={imgImage1466} />
        </div>
      </div>
    </div>
  );
...
function Frame29() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <img alt="Med X Visa icon" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1467} />
      </div>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <img alt="Flight Tickets icon" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1468} />
      </div>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <img alt="Accommodation icon" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1469} />
      </div>
    </div>
  );
}
...
function Frame35() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <img alt="Pickup & Drop icon" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1470} />
      </div>
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="bg-[rgba(245,230,211,0.5)] overflow-clip relative rounded-[10px] shrink-0 size-[64px]">
      <div className="absolute h-[49px] left-1/2 top-[calc(50%+0.15px)] translate-x-[-50%] translate-y-[-50%] w-[50px]" data-name="image 1466">
        <img alt="Translator icon" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={imgImage1471} />
      </div>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-[80px] top-[548px]">
      <p className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[16px] text-center text-nowrap tracking-[0.32px] whitespace-pre">Copyrights © 2025</p>
