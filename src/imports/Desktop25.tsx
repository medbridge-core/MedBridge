  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <div className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[0px] text-[32px] text-nowrap text-white tracking-[-0.64px] whitespace-pre">
        ...
        <p className="flex items-center">Instantly using{" "}<span className="inline-flex items-center gap-[2px] ml-[6px]"><span style={{ background: "linear-gradient(to right, #038DFE, #0BE0FA)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", fontWeight: 600, letterSpacing: "-0.64px" }}>AI</span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="inline-block" style={{ marginLeft: "2px", marginBottom: "2px" }}><defs><linearGradient id="sparkleGrad" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stopColor="#038DFE" /><stop offset="100%" stopColor="#0BE0FA" /></linearGradient></defs><path d="M12 2C12.1667 2 12.3129 2.11109 12.3574 2.27219C13.7565 7.33825 14.8112 8.39175 19.878 9.79082C20.0391 9.83526 20.1492 9.98154 20.1492 10.1482C20.1492 10.3148 20.0381 10.4611 19.878 10.5056C14.8112 11.9044 13.7565 12.9591 12.3574 18.0242C12.3129 18.1853 12.1667 18.2964 12 18.2964C11.8333 18.2964 11.6871 18.1853 11.6426 18.0242C10.2435 12.9581 9.18881 11.9046 4.12305 10.5056C3.96192 10.4611 3.85174 10.3148 3.85174 10.1482C3.85174 9.98154 3.96286 9.83526 4.12305 9.79082C9.18976 8.39175 10.2434 7.33825 11.6426 2.27219C11.6871 2.11109 11.8333 2 12 2Z" fill="url(#sparkleGrad)" /><path d="M19.5 14.5C19.6 14.5 19.69 14.566 19.716 14.661C20.04 15.834 20.264 16.059 21.437 16.383C21.532 16.409 21.598 16.496 21.598 16.595C21.598 16.694 21.532 16.781 21.437 16.807C20.264 17.131 20.04 17.357 19.716 18.53C19.69 18.625 19.6 18.691 19.5 18.691C19.4 18.691 19.31 18.625 19.284 18.53C18.96 17.357 18.736 17.131 17.562 16.807C17.467 16.781 17.401 16.694 17.401 16.595C17.401 16.496 17.467 16.409 17.562 16.383C18.736 16.059 18.96 15.834 19.284 14.661C19.31 14.566 19.4 14.5 19.5 14.5Z" fill="url(#sparkleGrad)" /><path d="M17.5 0C17.6 0 17.69 0.066 17.716 0.161C18.1 1.556 18.368 1.823 19.763 2.207C19.858 2.233 19.924 2.32 19.924 2.419C19.924 2.518 19.858 2.605 19.763 2.631C18.368 3.015 18.1 3.283 17.716 4.678C17.69 4.773 17.6 4.839 17.5 4.839C17.4 4.839 17.31 4.773 17.284 4.678C16.9 3.283 16.632 3.015 15.237 2.631C15.142 2.605 15.076 2.518 15.076 2.419C15.076 2.32 15.142 2.233 15.237 2.207C16.632 1.823 16.9 1.556 17.284 0.161C17.31 0.066 17.4 0 17.5 0Z" fill="url(#sparkleGrad)" /></svg></span></p>
      </div>
