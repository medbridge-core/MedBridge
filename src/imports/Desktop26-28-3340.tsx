import svgPaths from "./svg-12gvvaudy0";
...
function Frame124() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[56px] items-center left-1/2 top-[1053px] translate-x-[-50%] w-[1440px]">
      <Frame83 />
      <Frame84 />
      <Frame31 />
    </div>
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
      ...
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[14px] text-nowrap text-white tracking-[-0.28px] whitespace-pre">INR</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="backdrop-blur-[22px] backdrop-filter bg-[rgba(255,255,255,0.21)] box-border content-stretch flex gap-[10px] items-center overflow-clip p-[9px] relative rounded-[1000px] shrink-0">
      <ShoppingCartSimple />
    </div>
  );
}
...
function Frame181() {
  return (
    <div className="bg-[rgba(109,127,151,0.07)] box-border content-stretch flex gap-[4px] items-center px-[8px] py-[4px] relative rounded-[1000px] shrink-0">
      <MapPin3 />
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[14px] text-nowrap tracking-[0.28px] whitespace-pre">Mumbai</p>
    </div>
  );
}
...
function Frame202() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[20px] text-nowrap tracking-[-0.4px] whitespace-pre">Apollo Hospital Mumbai</p>
      <Frame181 />
    </div>
  );
}
...
function Frame211() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[20px] text-nowrap tracking-[-0.4px] whitespace-pre">{`Fortis Memorial Research Insitute  `}</p>
      <Frame183 />
    </div>
  );
}
...
function Frame215() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[20px] text-nowrap tracking-[-0.4px] whitespace-pre">Jupiter Hospital Mumbai</p>
      <Frame186 />
    </div>
  );
}
...
function Frame176() {
  return (
    <div className="bg-[#64b6ac] box-border content-stretch flex flex-col gap-[10px] items-center justify-center overflow-clip px-[32px] py-[14px] relative rounded-[6px] shrink-0">
      <Frame175 />
    </div>
  );
}
...
function Frame222() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[56px] items-center justify-center left-0 overflow-clip pb-[40px] pt-[64px] px-[80px] rounded-bl-[24px] rounded-br-[24px] top-0 w-[1440px]">
      <Frame30 />
      <Frame210 />
    </div>
  );
...
export default function Desktop() {
  return (
    <div className="bg-neutral-50 relative size-full" data-name="Desktop - 26">
      <Frame124 />
      <Frame222 />
    </div>
  );
