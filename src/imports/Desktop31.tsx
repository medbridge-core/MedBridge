import svgPaths from "./svg-2e3tcll3ez";
...
import imgImage1467 from "figma:asset/e96ce44e2847ca577d405f7326d8d8785499a445.png";
import imgImage1468 from "figma:asset/31a6369951e0556b8d36beba9515e94d6f9eaa77.png";
import imgImage1469 from "figma:asset/5ea5e58c43bf20ba5daa6567dbe9f446041e7258.png";
import imgImage1470 from "figma:asset/2536aa901460b8616ff5d88611d4b2fac54ab809.png";
import imgImage1471 from "figma:asset/0a50a454ce2bf8ffbd7759b545bd03878d4e68c3.png";
...
function Frame18() {
  return (
    <div className="backdrop-blur-[22px] backdrop-filter bg-[#e8eaee] box-border content-stretch flex flex-col gap-[10px] h-[38px] items-start justify-center overflow-clip px-[14px] py-[10px] relative rounded-[6px] shrink-0">
      <Frame20 />
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="backdrop-blur-[22px] backdrop-filter bg-[#e8eaee] box-border content-stretch flex gap-[10px] items-center overflow-clip p-[9px] relative rounded-[1000px] shrink-0">
      <ShoppingCartSimple />
    </div>
  );
}
...
function User() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="User">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="User">
          <path d={svgPaths.p1312d880} fill="var(--fill-0, #1E3A5F)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[14px] text-nowrap tracking-[-0.28px] whitespace-pre">Govind</p>
      <CaretCircleDown1 />
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[10px] h-full items-start justify-center px-[12px] py-0 relative rounded-[6px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[rgba(30,58,95,0.1)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <Frame22 />
    </div>
  );
}
    ...
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      ...
      <div className="absolute h-[24.436px] left-[210px] top-[52.33px] w-[57.999px]" data-name="Union">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 58 25">
          <path d={svgPaths.p14620200} fill="url(#paint0_linear_37_3800)" id="Union" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_37_3800" x1="-54.1733" x2="63.9466" y1="34.3667" y2="2.71202">
...
function Frame131() {
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Frame 280">
          <path d={svgPaths.p13b93e00} fill="url(#paint0_linear_37_3863)" id="Vector" />
          <path d={svgPaths.p23e5a550} fill="url(#paint1_linear_37_3863)" id="Vector_2" />
          <path d={svgPaths.p3d6df00} fill="url(#paint2_linear_37_3863)" id="Vector_3" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_37_3863" x1="3.70361" x2="20.983" y1="15.2724" y2="13.2878">
            <stop stopColor="#038DFE" />
            <stop offset="1" stopColor="#0BE0FA" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_37_3863" x1="1.17729e-07" x2="8.63956" y1="6.71008" y2="5.71791">
            <stop stopColor="#038DFE" />
            <stop offset="1" stopColor="#0BE0FA" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_37_3863" x1="1.66699" x2="9.12829" y1="18.7581" y2="17.9012">
            <stop stopColor="#038DFE" />
            <stop offset="1" stopColor="#0BE0FA" />
          </linearGradient>
        </defs>
...
function Frame110() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[40px] py-[32px] relative rounded-[16px] shrink-0 w-[543px]">
      <Frame108 />
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="bg-[rgba(100,182,172,0.1)] box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[20px] py-[6px] relative rounded-[50px] shrink-0">
...
function Frame49() {
  return (
    <div className="content-stretch flex gap-[8px] items-center leading-[normal] not-italic relative shrink-0 text-[#1e3a5f] text-[16px] text-nowrap tracking-[0.32px] whitespace-pre">
      ...
      <p className="font-['General_Sans:Medium',sans-serif] relative shrink-0">₹4000</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="h-[52px] relative shrink-0 w-[242.662px]">
...
function CaretCircleRight1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="CaretCircleRight">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="CaretCircleRight">
          <path d={svgPaths.p3e9c8000} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame144() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-center relative shrink-0 w-full">
      <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white tracking-[-0.32px] whitespace-pre">See How it Works</p>
      <CaretCircleRight1 />
    </div>
  );
}
...
function Frame147() {
  return (
    <div className="bg-[#1e3a5f] box-border content-stretch flex flex-col gap-[10px] items-start overflow-clip px-[16px] py-[10px] relative rounded-[4px] shrink-0">
      <Frame144 />
    </div>
  );
}
...
function Frame91() {
  return <div className="bg-[#ebebeb] rounded-[1000px] shrink-0 size-[72px]" />;
}
...
function Frame129() {
  return <div className="bg-[#ebebeb] rounded-[1000px] shrink-0 size-[52px]" />;
}
...
function Trash() {
  return (
    <div className="relative shrink-0 size-[14px]" data-name="Trash">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
        <g id="Trash">
          <path d={svgPaths.p12dc9b00} fill="var(--fill-0, #78899F)" fillOpacity="0.5" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame176() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[346px] overflow-clip p-[5px] rounded-[1000px] top-[102px]">
      <Trash />
    </div>
  );
}
...
function Frame183() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[normal] not-italic relative shrink-0 text-[#1a365d] w-full">
      <p className="font-['General_Sans:Medium',sans-serif] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">Fill in your details to confirm your request</p>
      <p className="font-['General_Sans:Regular',sans-serif] relative shrink-0 text-[12px] tracking-[-0.24px] w-full">Just a few details, we’ll reach out shortly with pricing.</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="basis-0 bg-white grow h-[51px] min-h-px min-w-px relative rounded-[10px] shrink-0">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[51px] items-center px-[12px] py-[17px] relative w-full">
          <p className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic opacity-90 relative shrink-0 text-[#909cb0] text-[14px] text-nowrap whitespace-pre">Enter your name</p>
        </div>
      </div>
...
function Frame171() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <p className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic opacity-60 relative shrink-0 text-[#909cb0] text-[16px] text-nowrap whitespace-pre">+91</p>
    </div>
  );
}
...
function CaretDown5() {
  return (
    <div className="relative shrink-0 size-[10px]" data-name="CaretDown">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g id="CaretDown">
          <path d={svgPaths.p186d2d00} fill="var(--fill-0, #BDC5D0)" id="Vector" />
        </g>
      </svg>
    </div>
  );
          ...
          <div className="flex h-[calc(1px*((var(--transform-inner-width)*1)+(var(--transform-inner-height)*0)))] items-center justify-center relative shrink-0 w-[calc(1px*((var(--transform-inner-height)*1)+(var(--transform-inner-width)*0)))]" style={{ "--transform-inner-width": "18", "--transform-inner-height": "0" } as React.CSSProperties}>
            <div className="flex-none rotate-[90deg]">
              <div className="h-0 relative w-[18px]">
                <div className="absolute bottom-0 left-0 right-0 top-[-1px]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 1">
                    <line id="Line 49" opacity="0.3" stroke="var(--stroke-0, #BDC5D0)" x2="18" y1="0.5" y2="0.5" />
                  </svg>
                </div>
              </div>
            </div>
          </div>
          <p className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic opacity-90 relative shrink-0 text-[#909cb0] text-[14px] text-nowrap whitespace-pre">Phone Number</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(26,54,93,0.1)] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function Frame14() {
  return (
    <div className="bg-white h-[51px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[51px] items-center px-[12px] py-[17px] relative w-full">
          <p className="font-['General_Sans:Regular',sans-serif] leading-[normal] not-italic opacity-90 relative shrink-0 text-[#909cb0] text-[14px] text-nowrap whitespace-pre">email address</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(26,54,93,0.1)] border-solid inset-0 pointer-events-none rounded-[10px]" />
    </div>
...
function CaretCircleRight2() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="CaretCircleRight">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="CaretCircleRight">
          <path d={svgPaths.p3c712400} fill="var(--fill-0, #98A1AE)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame17() {
  return (
    <div className="bg-[#e8eaee] h-[52px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[5px] h-[52px] items-center justify-center px-[40px] py-[13px] relative w-full">
          <p className="font-['General_Sans:Medium',sans-serif] leading-[normal] not-italic opacity-90 relative shrink-0 text-[#98a1ae] text-[16px] text-nowrap whitespace-pre">Submit Request</p>
          <CaretCircleRight2 />
        </div>
      </div>
    </div>
...
function Frame184() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[24px] top-[24px] w-[352px]">
      <Frame183 />
      <Frame178 />
      <Frame182 />
      <Frame17 />
...
function Frame177() {
  return (
    <div className="absolute bg-white bottom-0 h-[316px] left-1/2 translate-x-[-50%] w-[400px]">
      <div className="h-[316px] overflow-clip relative rounded-[inherit] w-[400px]">
        <Frame184 />
      </div>
      <div aria-hidden="true" className="absolute border-[2px_0px_0px] border-[rgba(100,182,172,0.5)] border-solid inset-0 pointer-events-none" />
    </div>
  );
}

function ShoppingCartSimple1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="ShoppingCartSimple">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="ShoppingCartSimple">
          <path d={svgPaths.p21130200} fill="var(--fill-0, #64B6AC)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame27() {
  return (
    <div className="backdrop-blur-[22px] backdrop-filter bg-white box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip p-[9px] relative rounded-[1000px] shrink-0 size-[38px]">
      <ShoppingCartSimple1 />
    </div>
  );
}
...
function Frame174() {
  return (
    <div className="content-stretch flex flex-col font-['General_Sans:Medium',sans-serif] items-start justify-center leading-[normal] not-italic relative shrink-0 text-nowrap whitespace-pre">
      <p className="relative shrink-0 text-[#1e3a5f] text-[16px] tracking-[-0.32px]">Your Cart</p>
      <p className="relative shrink-0 text-[#78899f] text-[12px] tracking-[-0.24px]">(4 Services)</p>
    </div>
  );
}
...
function X() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="X">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="X">
          <path d={svgPaths.p1bfd1d40} fill="var(--fill-0, #64B6AC)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Frame175() {
  return (
    <div className="backdrop-blur-[22px] backdrop-filter box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip p-[9px] relative rounded-[1000px] shrink-0 size-[38px]">
      <X />
    </div>
  );
}
...
function Frame179() {
  return (
    <div className="absolute bg-[rgba(100,182,172,0.1)] box-border content-stretch flex flex-col gap-[10px] items-start left-0 overflow-clip px-[24px] py-[20px] top-0 w-[400px]">
      <Frame173 />
    </div>
  );
}
...
function Frame180() {
  return (
    <div className="absolute bg-[#fafcfc] h-[844px] overflow-clip right-0 top-0 w-[400px]">
      <Frame176 />
      <Frame177 />
      <Frame179 />
    </div>
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop - 31">
      <Frame112 />
      <Frame111 />
      <Frame146 />
      <Frame145 />
      <div className="absolute backdrop-blur-md backdrop-filter bg-[rgba(0,0,0,0.7)] h-[844px] left-0 top-0 w-[1440px]" />
      <Frame180 />
    </div>
  );
}